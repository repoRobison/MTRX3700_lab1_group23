/*
 * Makes the physical button signal safe for the FPGA clock domain,
 * as the physical button isn't perfectly synchronised to the FPGA's 50 MHz clock.
 *
 * Synchronisers: Double-Register Incoming Data!
